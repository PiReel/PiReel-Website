...
/* [jWrite] Not Done */
  ...
  /* [jClone] */
  jClone: function(options)
    {
    },

  /* [createKeyLock] */
	createKeyLock: function(options)
	  {
	  var _proto = null;

	  vault[options.keyname] ? _proto = "Key lock already exists." : 
	    ( "" );
	  return _proto;
	  }
  };
...
var m_utilities = xtag.mixins.utilities = 
  {
  methods:
    {
    /* [getKeyRef] */
    get_key_refs: function(stg, options)
      {
      var key= null,
...
/* [j-form] */
var xForm = xtag.register( "j-form",
  {
  lifecycle:
    {
    inserted: function()
...
/* [j-input] */
var jInput = xtag.register("j-input", 
  {
  methods:
    {
    },
...
/* [j-viewport] */
var jViewport = xtag.register("j-viewport", 
  {
  lifecycle:
    {
    inserted: function()
