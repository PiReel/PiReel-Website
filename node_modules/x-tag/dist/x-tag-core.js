...
/* [jxCheckType] */
  jxCheckType: function(param)
    {
    var obj = { mime: null, spec: null };
      obj.spec = jx.type_keys.toString().match(param[0])[0];
      obj.mime = jx.mime_keys.toString().match(param[1])[0];
    return obj;
    }
  };

/* Begining of key def lock creation. */
var cFrag = jx.jxLock(
  {
  type: "instruct",
  token: "~",
...
var cJson = jx.jxLock(
  ...
  inherit: false,
  token: "/json",
  build: function(instructs)
    {
    console.log(instructs);console.log(this);
    }
  } );
    ...
    jReady: function(_func)
      ...
      var el = this,
        xhrCheck = window.setInterval( function(){
          if (jx.fire[el.id].xhr.readyState == 4 && jx.fire[el.id].xhr.status == 200)
            {
      ...
      dataType: 
        {
          attribute:
            ...
            validate: function(val)
              {
              var params = jx.jxCheckType( val.match(/\w+/g) );
              return params;
              }
            },
        set: function(val)
          {
          jx.fire[this.id]["spec"] = val.spec;
          jx.fire[this.id]["mime"] = val.mime;
...
/* [json-canvas] */
var jCanvas = xtag.register( "json-canvas",
  {
  mixins: ["utilities"],
  lifecycle:
    {
  ...
  events:
    ...
    tap: function()
      ...
      for(var i = 0; i<_fire.length; i++)
        ...
        (  this.getAttribute("selected") === "false" ? this.setAttribute("selected","true") : this.setAttribute("selected","false"),
    ...
    accessors:
      ...
      selected: 
        ...
        set: function(val)
          {
          val === "true" ? ( this.className = "jopt-selected" ) : this.className = "";
          return val;
          },
        get: function()
          {
